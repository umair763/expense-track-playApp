        ...
        <div className="flex gap-8">
          {tabs.map((tab) => (
            ...
            >
              ...
              {activeTab === tab.id && (
                <span className="absolute bottom-0 left-0 h-0.5 w-full rounded-full bg-[#4A02F9]" />
              )}
            </button>
          ))}
        </div>
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      <div className="flex items-center gap-5">
        <div className="relative">
          <img
            src={imagePreview || user?.photoURL || 'https://i.pravatar.cc/150?img=12'}
            alt="User"
          ...
          <button
            type="button"
            onClick={handleImageClick}
            className="absolute bottom-0 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-[#4A02F9] text-white shadow cursor-pointer"
          >
            <Camera size={15} />
          </button>
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            {user?.createdAt ? `Joined ${formatDate(user.createdAt)}` : 'Active User'}
          </p>
        </div>
      </div>
      ...
      <button
        ...
        disabled={loading}
        className="
          mt-6 rounded-lg bg-[#4A02F9] cursor-pointer
          px-5 py-2.5
            ...
            <div className="flex items-center gap-4">
              <div
                className="
                  ...
                  rounded-lg bg-purple-50 text-[#4A02F9]
                "
              >
                <Icon size={20} />
              </div>
    ...
    <div>
      ...
      <input
        ...
        className={`
          ...
          focus:border-[#4A02F9]
          focus:ring-2 focus:ring-[#4A02F9]/20
