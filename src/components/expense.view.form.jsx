      ...
      <div className="bg-white rounded-xl overflow-hidden flex flex-col w-full max-w-[800px] max-h-[90vh] font-sans">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <UiStatusPill
                ...
                color="#9333EA"
              />
              <UiStatusPill status={expense.title || 'N/A'} color="#3B82F6" />
            </div>
        ...
        <div className="px-6 py-4 flex justify-end flex-shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="inline-flex items-center justify-center h-10 min-w-[90px] px-5 rounded-lg font-sans text-sm font-medium text-white border-none bg-[#4F30A9] cursor-pointer transition-all hover:bg-[#4F30A9]/90"
          >
            Close
          </button>
        </div>
